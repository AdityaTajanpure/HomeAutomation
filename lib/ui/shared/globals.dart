...
class Global {
  ...
  static final List<Map> homeItems = [
    ...
    {'location': 'Fan', 'power': '4.6 Kwh', 'icon': Icons.toll},
    {'location': 'Out-Light', 'power': '', 'icon': Icons.lightbulb_outline},
    {'location': 'Small-Light', 'power': '', 'icon': Icons.lightbulb_outline},
  ];
}
